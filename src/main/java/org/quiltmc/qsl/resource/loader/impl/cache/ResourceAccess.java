...
public class ResourceAccess {
	...
	public Set<String> getNamespaces(ResourceType type) {
		try {
			...
			LOGGER.warn("getNamespaces in mod " + this.io.getModMetadata().getId() + " failed!", e);
			return Collections.emptySet();
		}
	}

	protected void warnInvalidNamespace(String s) {
		LOGGER.warn("Quilt NioResourcePack: ignored invalid namespace: {} in mod ID {}", s, this.io.getModMetadata().getId());
	}
