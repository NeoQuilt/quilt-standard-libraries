...
public class ItemContentRegistriesClientInitializer implements ClientModInitializer {
	...
	public void onInitializeClient(ModContainer mod) {
		if (Boolean.getBoolean(ENABLE_TOOLTIP_DEBUG) || FabricLoader.getInstance().isModLoaded("quilt_item_content_registry_testmod")) {
			if (FabricLoader.getInstance().isModLoaded("quilt_tooltip")) {
