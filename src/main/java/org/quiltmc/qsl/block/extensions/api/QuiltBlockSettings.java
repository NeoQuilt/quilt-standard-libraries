...
public class QuiltBlockSettings extends AbstractBlock.Settings {
	...
	public QuiltBlockSettings lavaIgnitable(boolean ignitable) {
		((AbstractBlockSettingsAccessor) this).setBurnable(ignitable);
		return this;
	}
	...
	public QuiltBlockSettings nonSolid(boolean nonSolid) {
		((AbstractBlockSettingsAccessor) this).setForceNotSolid(nonSolid);
		return this;
	}

	public QuiltBlockSettings solid(boolean solid) {
		((AbstractBlockSettingsAccessor) this).setForceSolid(solid);
		return this;
	}
	...
	public QuiltBlockSettings spawnsParticlesOnBreak(boolean spawnsParticlesOnBreak) {
		((AbstractBlockSettingsAccessor) this).setBlockBreakParticles(spawnsParticlesOnBreak);
		return this;
	}

	public Settings requiredFlags(FeatureFlagBitSet flags) {
		((AbstractBlockSettingsAccessor) this).setRequiredFeatures(flags);
		return this;
	}
